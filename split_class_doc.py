...
images_path = "C:\\Users\\vnmuser\\Desktop\\DUYLOC\\lib\\yolov5\\runs\\detect\\NGCAM2"
save_path = "C:\\Users\\vnmuser\\Desktop\\DUYLOC\\lib\\yolov5\\runs\\detect\\CHECK-LOI-NG-CAM_2-A93-yolov5s6"
class_names = ["namcham","me","namchamcao","nut","matbactruc","divat","divatkim","traybactruc"]
    ...
    if file_names != 'classes':
        ...
        for i in check :
            if i == "1":
                ...
                print(file,os.path.join(save_path,"me","labels",file.split('\\')[-1]))
                ...
                break
            if i == "2":
                if not os.path.exists(os.path.join(save_path,"namchamcao","labels")):
                    os.makedirs(os.path.join(save_path,"namchamcao","labels"))
                    os.makedirs(os.path.join(save_path,"namchamcao","images"))
                os.replace(file,os.path.join(save_path,"namchamcao","labels",file.split('\\')[-1]))
                os.replace(os.path.join(images_path,file_names+".bmp"),os.path.join(save_path,"namchamcao","images",file_names+".bmp"))
                break
            if i == "3":
